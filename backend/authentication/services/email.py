...
from authentication.utils.token import encode_uid, get_token_from_user
...
class EmailService:
    ...
    def send_user_creation_email(user):
        ...
        subject = 'Cathedral - Activate your account'
        to = (user.email,)
    ...
    def send_reset_password_email(user):
        ...
        subject = 'Cathedral - Reset your password'
        to = (user.email,)
    ...
    def send_change_email_request_email(user, new_email, token):
        ...
        subject = 'Cathedral - Confirm your email address'
        to = (new_email,)
    ...
    def send_email_changed_email(user, previous_email):
        ...
        subject = 'Cathedral - Your email address has been changed'
        to = (previous_email,)
